        ...
        <div class="login t<?php echo $_SESSION['role'] ?>">
            ...
            <form action="./scripts/add-comment-query.php" method="post">
                ...
                <div class="container_obj">
                    ...
                    <input style="border-radius: 8px; width: 200px; height: 25px;" type="text" name="title">
                </div>
                <div class="container_obj">
                    <label for="description">Yorum</label><br>
                    <input style="border-radius: 8px; width: 200px; height: 25px;" type="text" name="description">
                </div>
                <div class="container_obj">
                    <label for="score">Skor</label><br>
                    <input style="border-radius: 8px; width: 200px; height: 25px;" type="number" min="0" max="10" name="score">
                </div>
