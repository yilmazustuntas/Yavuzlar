...
<body>
    <div class="centerDiv">
        <div class="centerDiv">
            ...
            <a href="./add-restaurant.php"><button style="border-radius: 15px; background-color: #ffc400; color: black;">Restoran Ekle</button></a>
        </div>
                ...
                <tbody>
                    <?php foreach ($restaurants as $restaurant): ?>
                        <tr class="t<?php echo $_SESSION['role']; ?> dataElement dataTable">
                            ...
                            <td>
                                <a href="update-restaurant.php?r_id=<?php echo $restaurant['id']; ?>"><button style="border-radius: 15px;">Güncelle</button></a>
                            </td>
                            <td>
