            ...
            <form action="./scripts/add-food-query.php" method="post" enctype="multipart/form-data">
                ...
                <div>
                    <div class="container_obj">
                        ...
                        <input style="border-radius: 15px; width: 200px; padding: 5px; margin-top: 10px;" type="text" name="name" placeholder="Yemek Adı" required />
                    </div>

                    <div class="container_obj">
                        <label for="description">Açıklama:</label><br>
                        <input style="border-radius: 15px; width: 200px; padding: 5px; margin-top: 10px;" type="text" name="description" placeholder="Açıklama" required />
                    </div>
                    ...
                    <div class="container_obj">
                        ...
                        <input style="border-radius: 15px; width: 200px; padding: 5px; margin-top: 10px;" type="number" min="1" name="price" placeholder="Yemek Fiyatı" required />
                    </div>

                    <div class="container_obj">
                        <label for="discount">İndirim:</label><br>
                        <input style="border-radius: 15px; width: 200px; padding: 5px; margin-top: 10px;" type="number" min="0" max="100" name="discount" placeholder="İndirim" required />
                    </div>

                    <div class="container_obj">
                        <label for="restaurant_id">Restoran:</label><br>
                        <select style="border-radius: 15px; width: 200px; padding: 5px; margin-top: 10px;" name="restaurant_id" id="restaurant_id">
                ...
                <button style="border-radius: 15px;" type="submit">Ekle</button>
            </form>
        </div>
    </div>
