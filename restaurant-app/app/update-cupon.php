            ...
            <div class="login t<?php echo $_SESSION['role']; ?>">
                ...
                <form action="./scripts/update-cupon-query.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="container_obj">
                        ...
                        <input style="border-radius: 15px; width: 200px; padding: 5px; margin-top: 10px;" type="text" name="name" placeholder="Kupon Adı" value="<?php echo $cupon['name']; ?>" required />
                    </div>
                    <div class="container_obj">
                        <label for="discount">İndirim</label><br>
                        <input style="border-radius: 15px; width: 200px; padding: 5px; margin-top: 10px;" type="number" min="1" max="100" name="discount" placeholder="İndirim" value="<?php echo $cupon['discount']; ?>" required />
                    </div>
                    <div class="container_obj">
