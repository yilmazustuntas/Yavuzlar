...
?>
    ...
    <body>
        <div class="centerDiv">
            <div class="centerDiv">
                <h1>Kuponlar</h1>
                <a href="add-cupon.php" class=" cleanText"><button style="border-radius: 15px;">Kupon Ekle</button></a>
            </div>
            <?php if (empty($cupons)) {
                echo "<p>Herhangi bir kupon bulunamadı.</p>";
            } else { ?>
                <div class="searchbox">
                    <input style="border-radius: 8px; width: 200px;" type="search" id="searchbox" placeholder="Kupon Ara" />
                </div>
                    ...
                    <tbody>
                        <?php foreach ($cupons as $cupon): ?>
                            <tr class="t<?php echo $_SESSION['role']; ?> dataElement dataTable">
                                ...
                                <td>
                                    <a href="update-cupon.php?c_id=<?php echo $cupon['id']; ?>"><button style="border-radius: 15px;">Güncelle</button></a>
                                </td>
                                <td>
        ...
        <a href="index.php" style="margin-top: 1.5rem;" class="searchbox cleanText"><button style="border-radius: 15px;">Ana Sayfa</button></a>
