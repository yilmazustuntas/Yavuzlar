        ...
        <?php if (empty($datas)) {
                    ...
                    <tbody>
                        <?php foreach ($datas as $data): ?>
                            <tr class="dataElement dataTable t<?php echo $_SESSION['role']; ?>">
                                ...
                                <td>
                                    <p style="border-radius: 15px;" class="<?php echo $data['food_discount'] ? "highlight" . $_SESSION['role'] : ""; ?>">
                                        <?php
                                ...
                                <td>
                                    <form action="./scripts/delete-basket-item.php" method="post">
                                        <input type="hidden" name="basket_id" value="<?php echo $data['basket_id']; ?>">
                                        <button style="border-radius: 15px; background-color: #59b471;" type="submit">X</button>
                                    </form>
                                </td>
                            </tr>
                        <?php
            ...
            <div class="centerDiv ">
                <form action="./scripts/apply-cupon.php" method="post">
                    ...
                    <input style="border-radius: 8px; width: 200px; height: 25px;" type="text" name="c_name">
                    <button style="border-radius: 15px; background-color: #59b471;" type="submit">Uygula</button>
                </form>
                <p>
