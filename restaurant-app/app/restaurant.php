...
<body>
    <div class="centerDiv">
        <?php if (empty($datas)) {
            ...
            echo "<a href='add-comment.php?r_id=" . $restaurant_id . "'><button style='border-radius: 15px; background-color: #59b471;'>Yorum Ekle</button></a></div>";
        } else { ?>
            ...
            <a href="add-comment.php?r_id=<?php echo $restaurant_id; ?>"><button style="border-radius: 15px; background-color: #59b471;">Yorum Ekle</button></a>
                        ...
                        <?php foreach ($datas as $data): ?>
                            <tr class="dataElement t<?php echo $_SESSION['role']; ?>">
                                ...
                                <form action="./scripts/delete-comment.php" method="post">
                                        ...
                                        <input type="hidden" name="r_id" value="<?php echo $restaurant_id; ?>"> <!-- Doğru r_id burada olmalı -->
